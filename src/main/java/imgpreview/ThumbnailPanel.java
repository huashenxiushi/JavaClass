...
public class ThumbnailPanel extends BorderPane {
    ...
    private static final MainController MAIN_WINDOWS_CONTROLLER;
    ...
    static {
        MAIN_WINDOWS_CONTROLLER = (MainController) ControllerMap.getController(MainController.class);
    ...
    public ThumbnailPanel(ImageFile imageFile, double size) {
        ...
        this.setOnMouseClicked(event -> {
            ...
            if (event.getButton() == MouseButton.PRIMARY && event.getClickCount() == 1) {
                DisplayImage parent = (DisplayImage) this.getParent();
                //按下Ctrl键时对图片进行选择
     ...
     */
    public void select() {
        this.setStyle("-fx-background-color: #b1b2aa");
